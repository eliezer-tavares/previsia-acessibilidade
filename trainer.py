...
def treina_modelo():
    ...
    try:
        ...
        df = df[df["label_score_acessibilidade"] != -1].dropna(
            subset=["label_score_acessibilidade"]
        )
        ...
        scaler = QuantileTransformer(
            output_distribution="normal", n_quantiles=min(1000, len(X))
        )
        ...
        )  # Scheduler for finer convergence
